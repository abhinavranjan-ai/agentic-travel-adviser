...
from src.agentic_trip_adviser.crews.travel_planning_crew import TravelPlanningCrew
    ...
    def load_ui(self):
        ...
        if st.button("🚀 Generate Travel Plan"):
            if not from_city or not destination_city or not date_from or not date_to or not interests:
                ...
                crew = TravelPlanningCrew(from_city, destination_city, date_from, date_to,interests, api_key).get_travel_planning_crew()
                # result = crew.kickoff()
